...
1. Provide an HTML slide deck such as [`ioslides`]() or [`xaringan`]()
...
One of the easiest ways to create them is to use Rstudio's guided process. For more information, see ...
...
Then close the opened ".Renviron" file.
