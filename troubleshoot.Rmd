...
To learn R effectively, you need to learn how to get unstuck with R. Remember that everyone, event the experts in R, still get stuck and stumped. I've been programming with R almost every day for 7 years and I still come across issues I can't solve. Sometimes they're complex, but more often than not, they are simple issues to do with typos, or me not using something correctly. As you get more confidence with using R, you will become faster at becoming unstuck.
...
- This [blog post](https://www.njtierney.com/post/2020/05/29/there-is-no-pkg/) helps address one of the variants of this error:
